...
export class GitCurrent extends React.Component {
  constructor(props) {
    super(props);
    this.gitCurrent = { score: 38 };
    ...
    this.data = [
      {
        ...
        name: "Current status",
        r: [25, 20, 23],
        theta: ["During pass", "Before pass", "After pass"],
        fill: "toself",
    ...
    positioning
      ...
      .attr(
        ...
        d3
          ...
          .outerRadius(60)
          .startAngle(0)
          .endAngle(((Math.PI * 2) / 70) * this.gitCurrent.score)
      )
      .attr("fill", "#E64E24");
  }
